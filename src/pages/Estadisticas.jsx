...
import ParticipacionOro from "../components/ParticipacionOro";
import RankingLugares from "../components/RankingLugares";
...
const [mostrarOro, setMostrarOro] = useState(false);
...
{/* ===============================
    PARTICIPACIÓN EN FECHAS DE ORO
=============================== */}
{/* ===============================
    RANKING DE LUGARES
=============================== */}
<div className="grafico-carrera">
  <div
    className="grafico-toggle"
    onClick={() => setMostrarLugares(!mostrarLugares)}
    style={{
      cursor: "pointer",
      display: "flex",
      alignItems: "center",
  ...
  {mostrarLugares && (
    <RankingLugares eventos={eventos} />
  )}
</div>
{/* ===============================
    PARTICIPACIÇ"N EN FECHAS DE ORO
=============================== */}
<div className="grafico-carrera">
  <div
    className="grafico-toggle"
    onClick={() => setMostrarOro(!mostrarOro)}
    style={{
      cursor: "pointer",
      display: "flex",
      alignItems: "center",
